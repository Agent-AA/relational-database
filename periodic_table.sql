...
--
-- Name: properties type_id_reference; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT type_id_reference FOREIGN KEY (type_id) REFERENCES public.types(type_id);
